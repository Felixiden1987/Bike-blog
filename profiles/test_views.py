...
class TestProfileView(TestCase):
    ...
    def test_profile_view(self):
        ...
        self.assertEqual(len(response.context['comments']), 2)  # Since we created 2 comments
    ...
    def test_profile_view_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/profiles/profiles/')  # Adjust the redirect URL as necessary
